                ...
                if start_end_prop:  # Check if start_end_prop is not None and not empty
                    ...
                    if start_end != start:
                        ...
                        with lock:
                            ...
                            # Only update 'end' if it exists in start_end_prop
                            if 'end' in start_end_prop:
                                ...
                                start_end_list.append(None)  # Keep end as None if it doesn't exist

                            update_page_properties(notion, local_data.page, 'Start', 'End', 'StartEnd', start, end_date if 'end' in start_end_prop else None, start_end_list)
