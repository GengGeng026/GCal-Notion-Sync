...
class ProgressThread(threading.Thread):
    ...
    def run(self):
        while not self.stop_event.is_set():
            ...
            bar = '\x1b[92m' + '━' * filled_length + '\x1b[0m'  # 熒光綠色
...
def complex_task(progress_thread, size):
    ...
    progress_thread.update_progress(size)  # 更新進度值
...
if __name__ == "__main__":
    ...
    try:
        for _ in range(10):  # 分10次完成，模擬下載過程
            complex_task(progress_thread, total_size / 10)
    finally:
