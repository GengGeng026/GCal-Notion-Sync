...
# 示例使用
# continue_animation 参数可以是一个函数，该函数返回一个布尔值，指示是否继续动画
animate_text_wave("Hello World", repeat=1, sleep_time=0.01, continue_animation=lambda: False)
