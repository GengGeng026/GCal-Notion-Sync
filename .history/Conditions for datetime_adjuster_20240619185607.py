...
start = None  # Define the start variable
if Start is None and End is None and StartEnd is None:
    startEnd to span from Start to Endreplace(hour=8, minute=0, second=0, microsecond=0)
    end = start + datetime.timedelta(hours=1)
    start_end = (start, end)artEnd to span from Start to End
