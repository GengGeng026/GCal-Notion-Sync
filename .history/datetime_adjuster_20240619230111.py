        ...
        if start is not None and start_end is not None:
            ...
            if StartEnd_to_Overwrite_All == True:
                ...
                if start_end_prop:  # Check if start_end_prop is not None and not empty
                    ...
                    # Removed the condition that overwrites end with start
                    ...
                    with lock:
                        ...
                        # 假设有一个函数check_if_end_needs_update()来决定是否需要更新End
                        if check_if_end_needs_update(start_end_prop, current_end):
                            # 如果需要更新End，则按原有逻辑继续
                            ...
                            # 如果不需要更新End，则跳过更新End的逻辑
                            end_date = None  # 明确设置end_date为None，避免无意中覆盖

                        # Only add End to the list if it needs to be updated
