                ...
                if start_end_prop:  # Check if start_end_prop is not None and not empty
                    ...
                    if start_end != start:
                        ...
                        with lock:
                            ...
                            # Determine if 'end' should be updated or kept as None
                            ...
                            elif 'end' not in start_end_prop:
                                # If 'end' is not in start_end_prop, it implies we might want to keep it as None or unchanged
                                # If you want to explicitly set it to None when not present, uncomment the next line
                                # start_end_list.append(None)
                                pass  # Do nothing, implying end_date remains unchanged or None based on earlier logic
