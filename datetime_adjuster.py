...
formatted_dot = format_string('.', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('.', 'C2', bold=True))
formatted_left_parenthesis = format_string(' (', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string(' (', 'C2', bold=True))
formatted_right_parenthesis = format_string(')', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string(')', 'C2', bold=True))
formatted_BOLD_italic = format_string('{}', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('{}', bold=True, italic=True))
formatted_right_arrow = format_string(' ▸ ', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string(' ▸ ', 'C2', bold=True))
formatted_indicator = format_string('{}', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('{}', 'C2', bold=True))
formatted_successful = format_string('Successful', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Successful', 'C2', bold=True))
formatted_failed = format_string('Failed', 'C3', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Failed', 'C3', bold=True))
formatted_page_title = format_string('page_title', 'C1', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('page_title', 'C1', bold=True))
formatted_start = format_string('Start', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Start', bold=True))
formatted_end = format_string('End', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('End', bold=True))
formatted_startend = format_string('StartEnd', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('StartEnd', bold=True))
formatted_condition_met = format_string('Condition Met', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Condition Met', bold=True))
formatted_no = format_string('No', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('No', bold=True, italic=True))
formatted_has_time = format_string('has time', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('has time', bold=True, italic=True))
formatted_changed = format_string('Changed', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Changed', bold=True, italic=True))
formatted_initially_modified = format_string('initially Modified', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('initially Modified', bold=True, italic=True))
formatted_count = format_string('{}', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('{}', 'C2', bold=True))
formatted_slash = format_string('/', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('/', 'C2', bold=True))
formatted_colon = format_string(':', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string(':', 'C2', bold=True))
formatted_semicolon = format_string(';', 'C1', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string(';', 'C1', bold=True))
formatted_or = format_string('or', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('or', bold=True))
formatted_and = format_string('and', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('and', bold=True))
formatted_as = format_string('as', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('as', bold=True))
formatted_is = format_string('is', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('is', bold=True))
formatted_are = format_string('are', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('are', bold=True))
formatted_s = format_string('(s)', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('(s)', bold=True))
formatted_reset_default_setting = format_string('RESET accordingly Default Setting', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('RESET accordingly Default Setting', 'C2', bold=True))
formatted_default_time = format_string('Default Time', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Default Time', 'C2', bold=True))
formatted_time_range = format_string('Time-Range', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Time-Range', 'C2', bold=True))
formatted_explicitly_set = format_string('Explicitly Set', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Explicitly Set', bold=True))
formatted_explicitly_set_0000 = format_string('Explicitly set to 00:00', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Explicitly set to 00:00', bold=True))
formatted_alldaysevent = format_string('All', bold=True) + '-' + format_string('Day', bold=True) + format_string('(s)', 'C2', bold=True) + '-' + format_string('Event', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('All-Day-Event', 'C2', bold=True))
formatted_part1 = format_string('All', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('All', bold=True))
...
formatted_have_time = format_string('got Time', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('got Time', bold=True, italic=True))
formatted_have_single_date = format_string('got Single-Date', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('got Single-Date', bold=True, italic=True))
formatted_single_date = format_string('Single-Date', 'C2', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Single-Date', 'C2', bold=True, italic=True))
formatted_no_time = format_string('No Time', 'C1', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('No Time', 'C1', bold=True, italic=True))
formatted_is_filled_accordingly = format_string('is Filled accordingly', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('is Filled accordingly', 'C2', bold=True))
formatted_is_filled_single_date = format_string('is Filled Single-Date', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('is Filled Single-Date', 'C2', bold=True))
formatted_overwritten = format_string('Overwritten', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Overwritten', 'C2', bold=True))
formatted_done = format_string('Done', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Done', 'C2', bold=True))
formatted_Printing = format_string('Printing', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Printing', 'C2', bold=True))
formatted_error = format_string('error', 'C3', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('error', 'C3', bold=True))
formatted_plain_none = format_string('None', italic=True, less_visible=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('None', italic=True, less_visible=True))
formatted_plain_previous = format_string('Previous', italic=True, less_visible=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Previous', italic=True, less_visible=True))
formatted_AFTER = format_string('AFTER', 'C1', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('AFTER', 'C1', bold=True, italic=True))
formatted_none = format_string('None', 'C1', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('None', 'C1', bold=True, italic=True))
formatted_all_none = format_string('All None', 'C1', bold=True, italic=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('All None', 'C1', bold=True, italic=True))
formatted_modified = format_string('Modified', 'C2', bold=True) if 'JENKINS_HOME' not in os.environ else skip_in_jenkins(lambda: format_string('Modified', 'C2', bold=True))
